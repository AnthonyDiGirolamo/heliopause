...
class Starfield:
    def __init__(self, screen_width, screen_height, max_stars):
        ...
        self.stars = [
            [float(randrange(0, self.screen_width)), float(randrange(0, self.screen_height)),
    ...
    def scroll(self, heading=0.0, velocity=0.0):
        ...
        for star in self.stars:
            ...
            if star[0] >= self.screen_width-1:
                star[0] = 0
                star[1] = randrange(0, self.screen_height-1)
                star[2] = choice(self.parallax_speeds)
            elif star[0] < 0:
                star[0] = self.screen_width-1
                star[1] = randrange(0, self.screen_height-1)
                star[2] = choice(self.parallax_speeds)
            elif star[1] >= self.screen_height-1:
                star[0] = randrange(0, self.screen_width-1)
                star[1] = 0
                star[2] = choice(self.parallax_speeds)
            elif star[1] < 0:
                star[0] = randrange(0, self.screen_width-1)
                star[1] = self.screen_height-1
                star[2] = choice(self.parallax_speeds)
