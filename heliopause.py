...
lib = cdll.LoadLibrary('./libcustomrender.dylib')

def custom_render(sdl_surface):
    print(type(sdl_surface))
    print(sdl_surface)
    lib.draw_line(sdl_surface, 0, 0, 50, 50)
    print("custom render")
...
libtcod.sys_register_SDL_renderer(custom_render)
